...
//     new favorite({address: req.body.address, user: req.session.passport.user}).save(function(err, doc){
//         if(err) res.json(err);
//         else res.redirect('/');
//     });
// });
...
//     favorite.remove({_favorite: req.params.id}, function(err){
//         res.redirect('/');
//     });
// });

// router.post('/update', function(req, res){
//     favorite.where({_favorite: req.body.favorite}).update({status: req.body.statuss}, function(err, doc){
//         if(err) res.json(err);
//         else res.send(200);
//     });
// });
